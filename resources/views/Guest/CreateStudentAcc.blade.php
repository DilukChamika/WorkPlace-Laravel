...
<center>
    <div id="createaccbox">  
        <br><img src="{{asset( 'images/WorkplaceIcon.png' )}}" alt="Company Logo" style=" height: 64px; width: auto;" class="companyLogo"/><br><br>
        <h5><u><b>Student Registration</b></u></h5><br>
      <form action="/storeStuData" method="POST" enctype="multipart/form-data">
        @csrf
          ...
          <a href="/login"><input type="button" value="Log In" id="createacc-logBtn"></a> <br><br>
      </form>
  </div>
</center>
